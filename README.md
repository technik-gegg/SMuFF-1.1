...
+ merged the [FYSETC AIOII](https://wiki.fysetc.com/AIO_II/) controller board from Gustavo Alvareu (sl1pkn07). This controller board resembles the Wanhao i3 mini but comes with an 32 bit STM32 MCU.
